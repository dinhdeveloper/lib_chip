...
class CardFileInputStr(cardFileInputStream: CardFileInputStream) :
    DataGroup(109, cardFileInputStream) {

    companion object {
        val f525r = Logger.getLogger("org.jmrtd")
        val f526s =
            charArrayOf('0', 17.toChar(), 2.toChar(), 1.toChar(), 1.toChar(), 19.toChar(), '\u000C')
        val f527t =
            charArrayOf('0', 28.toChar(), 2.toChar(), 1.toChar(), 2.toChar(), '\u000C', 23.toChar())
        val f528u =
            charArrayOf('0', 15.toChar(), 2.toChar(), 1.toChar(), 3.toChar(), 19.toChar(), '\n')
        val f529v = charArrayOf('0', '\b', 2.toChar(), 1.toChar(), 4.toChar(), '\u000C', 3.toChar())
        val f530w =
            charArrayOf('0', 15.toChar(), 2.toChar(), 1.toChar(), 5.toChar(), '\u000C', '\n')
        val f531x = charArrayOf('0', '\t', 2.toChar(), 1.toChar(), 6.toChar(), '\u000C', 4.toChar())
        val f532y =
            charArrayOf('0', 11.toChar(), 2.toChar(), 1.toChar(), 7.toChar(), '\u000C', 6.toChar())
        ...
        val f536C =
            charArrayOf('0', 15.toChar(), 2.toChar(), 1.toChar(), 11.toChar(), 19.toChar(), '\n')
        ...
        val f541H =
            charArrayOf('0', 14.toChar(), 2.toChar(), 1.toChar(), 15.toChar(), 19.toChar(), '\t')
        val f542I = charArrayOf(
            '0',
            21.toChar(),
            2.toChar(),
            1.toChar(),
            ...
            while (i5 < arrayList.size - 1) {
                ...
                if (copyOfRange.size >= 5) {
                    when (copyOfRange[4]) {
                            ...
                            if (arrayList2.size != 2) {
                                ...
                                fatherName = String(
                                    copyOfRange.copyOfRange(
                                        arrayList2[0] + f539F.size,
                                        arrayList2[1]
                                    )
                                )
                                motherName = String(
                                    copyOfRange.copyOfRange(
                                        arrayList2[1] + f540G.size,
                                        copyOfRange.size
                                    )
                                )
                            }
                        ...
                        15.toChar() -> oldNumber =
                            String(copyOfRange.copyOfRange(f541H.size, copyOfRange.size))

                        16.toChar() -> unkIdNumber =
                            String(copyOfRange.copyOfRange(f542I.size, copyOfRange.size))
